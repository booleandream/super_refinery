                        ...
                        <form action="detail.php" id='form' class="form-inline" role="form" method="GET">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="product" name="product">
                                    <option value='all' <?php if (isset($_GET['product']) && $_GET['product'] == 'all') echo 'selected="selected"'; ?> >All Products</option>
                                    <option value='SBPS' <?php if (isset($_GET['product']) && $_GET['product'] == 'SBPS') echo 'selected="selected"'; ?> >SBPS</option>
                                    <option value='MS' <?php if (isset($_GET['product']) && $_GET['product'] == 'MS') echo 'selected="selected"'; ?> >MS</option>
                                    <option value='SS1' <?php if (isset($_GET['product']) && $_GET['product'] == 'SS1') echo 'selected="selected"'; ?> >SS1</option>
                                    <option value='SS1(S)' <?php if (isset($_GET['product']) && $_GET['product'] == 'SS1(S)') echo 'selected="selected"'; ?> >SS1(S)</option>
                                    <option value='SS1(P)' <?php if (isset($_GET['product']) && $_GET['product'] == 'SS1(P)') echo 'selected="selected"'; ?> >SS1(P)</option>
                                    <option value='LMS' <?php if (isset($_GET['product']) && $_GET['product'] == 'LMS') echo 'selected="selected"'; ?> >LMS</option>
                                    <option value='MTT' <?php if (isset($_GET['product']) && $_GET['product'] == 'MTT') echo 'selected="selected"'; ?> >MTT</option>
                                    <option value='MTT(P)' <?php if (isset($_GET['product']) && $_GET['product'] == 'MTT(P)') echo 'selected="selected"'; ?> >MTT(P)</option>
                                    <option value='KSO' <?php if (isset($_GET['product']) && $_GET['product'] == 'KSO') echo 'selected="selected"'; ?> >KSO</option>
                                    <option value='DIESEL' <?php if (isset($_GET['product']) && $_GET['product'] == 'DIESEL') echo 'selected="selected"'; ?> >DIESEL</option>
                                </select>
                            </div>
